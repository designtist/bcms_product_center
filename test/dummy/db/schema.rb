...
ActiveRecord::Schema.define(:version => 20130222204431) do

  create_table "bcms_product_center_patch_versions", :force => true do |t|
  ...
  create_table "bcms_product_center_patches", :force => true do |t|
    t.integer  "version"
  ...
  create_table "bcms_product_center_product_client_mappings", :force => true do |t|
    t.integer  "user_id"
    t.integer  "product_id"
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  ...
  create_table "bcms_product_center_product_versions", :force => true do |t|
    t.integer  "original_record_id"
    t.integer  "version"
    t.string   "name"
    t.text     "description"
  ...
  create_table "bcms_product_center_products", :force => true do |t|
    t.integer  "version"
    t.integer  "lock_version",  :default => 0
    t.string   "name"
    t.text     "description"
